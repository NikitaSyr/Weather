...
public class MainActivity extends AppCompatActivity {
    ...
    {
        Toast.makeText(this, "Идёт получение данных о погоде", Toast.LENGTH_SHORT).show();
    ...
    private class GisAsyncTask extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... voids) {
            String result;
            try {
                URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=3e6560b786cfe0ab04af7db050bbbdab");
